    ...
    public class DialogParser
    {
        ...
        public List<Info> GetInfos()
        {
            ...
            if (startNode != null && startNode.nodeElement != null)
            {
                ...
                else if (startNode.typeNodeElement == typeof(Mission) || startNode.typeNodeElement == typeof(Option))
                { //Falls Startknoten Mission oder Option (einzige weiteren Knoten mit Lauf nach unten
