...
public class WorkerMenu : MonoBehaviour
{
    ...
    private string roomName = "Szene1";

    private Vector2 scrollPos = Vector2.zero;

    private bool connectFailed = false;

    public static readonly string SceneNameMenu = "Midgard-Scene";

	public static readonly string SceneNameGame = "MidgardGame-Scene";
    ...
    public void OnGUI()
    {
        ...
        GUI.Box(content, "Joine oder erzeuge Raum");
        ...
        GUILayout.Label("Spielername:", GUILayout.Width(150));
        PhotonNetwork.playerName = "Ufo";
        ...
        // Join room by title
        GUILayout.BeginHorizontal();
        GUILayout.Label("Raumname:", GUILayout.Width(150));
        this.roomName = GUILayout.TextField(this.roomName);

        if (GUILayout.Button("Erzeuge", GUILayout.Width(150)))
        {
        ...
        //this.roomName = GUILayout.TextField(this.roomName);
        if (GUILayout.Button("Trete bei", GUILayout.Width(150)))
        {
        ...
        GUILayout.Label(PhotonNetwork.countOfPlayers + " User sind online in " + PhotonNetwork.countOfRooms + " Räumen.");
        GUILayout.FlexibleSpace();
        ...
        {
            GUILayout.Label("Momentan kein Spiel verfügbar.");
            GUILayout.Label("Räume werden aufgelistet, sobald sie verfügbar sind.");
        }
        else
        {
            GUILayout.Label(PhotonNetwork.GetRoomList().Length + " Räume verfügbar:");
